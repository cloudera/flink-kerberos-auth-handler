...
public class ClientKerberosAuthHandlerFactory implements OutboundChannelHandlerFactory {

    private static final Logger LOG =
            LoggerFactory.getLogger(ClientKerberosAuthHandlerFactory.class);

    public ClientKerberosAuthHandlerFactory() {}
    ...
    public Optional<ChannelHandler> createHandler(Configuration configuration)
        ...
        LOG.info("Creating kerberos client authentication handler");
        return Optional.of(
                new ClientKerberosHttpAuthenticator(new SecurityConfiguration(configuration)));
    }
}
